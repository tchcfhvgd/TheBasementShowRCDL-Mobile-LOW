...
class FlxAnimation extends FlxBaseAnimation
{
	 ...
	 */
	public var finished(get, null):Bool = true;
	 ...
	 */
	@:isVar
	public var reversed(get, set):Bool = false;
	...
	function set_frameRate(value:Float):Float
	{
		...
		if(parent.animateAtlas != null) {
            return parent.animateAtlas.anim.frameRate = value; // Hacky way
        }
		return value;
	}
	...
	{
		if(parent.animateAtlas != null) return parent.animateAtlas.anim.length; // Hacky way
		return frames.length;
	}

	function get_finished() {
		if(parent.animateAtlas != null) return parent.animateAtlas.anim.finished; // Hacky way
		return finished;
	}
	function set_reversed(value:Bool) {
		reversed = value;
		if(parent.animateAtlas != null) return parent.animateAtlas.anim.reversed = value; // Hacky way
		return value;
	}
	function get_reversed() {
		if(parent.animateAtlas != null) return parent.animateAtlas.anim.reversed; // Hacky way
		return reversed;
	}
}
